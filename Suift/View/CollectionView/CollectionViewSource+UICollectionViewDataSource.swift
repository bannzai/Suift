//
//  CollectionViewSource+UICollectionViewDataSource.swift
//  Suift
//
...
extension CollectionViewSource: UICollectionViewDelegateFlowLayout {
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if let size = itemDelegate(indexPath: indexPath)?
            .size(for: collectionView, indexPath: indexPath) {
            return size
        }
...
fileprivate extension CollectionViewSource {
    ...
    func itemDelegate(item: CollectionViewItem) -> CollectionViewItemDelegatable? {
